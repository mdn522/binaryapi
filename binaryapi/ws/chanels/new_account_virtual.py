...
class NewAccountVirtual(Base):
    ...
    def __call__(self, client_password: str, residence: str, verification_code: str, affiliate_token: Optional[str] = None, date_first_contact: Optional[str] = None, gclid_url: Optional[str] = None, signup_device: Optional[str] = None, utm_ad_id: Optional[str] = None, utm_adgroup_id: Optional[str] = None, utm_adrollclk_id: Optional[str] = None, utm_campaign: Optional[str] = None, utm_campaign_id: Optional[str] = None, utm_content: Optional[str] = None, utm_fbcl_id: Optional[str] = None, utm_gl_client_id: Optional[str] = None, utm_medium: Optional[str] = None, utm_msclk_id: Optional[str] = None, utm_source: Optional[str] = None, utm_term: Optional[str] = None, passthrough: Optional[Any] = None, req_id: Optional[int] = None):
