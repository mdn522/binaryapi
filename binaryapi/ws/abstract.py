...
class AbstractAPI:
    @property
    def active_symbols(self) -> ActiveSymbols:
    ...
    def api_token(self) -> ApiToken:
        ...
        """
        return ApiToken(self)

    @property
    def app_delete(self) -> AppDelete:
        ...
        """
        return AppDelete(self)

    @property
    def app_get(self) -> AppGet:
    ...
    @property
    def app_markup_details(self) -> AppMarkupDetails:
        ...
        """
        return AppMarkupDetails(self)

    @property
    def app_register(self) -> AppRegister:
        ...
        """
        return AppRegister(self)

    @property
    def app_update(self) -> AppUpdate:
    ...
    @property
    def buy_contract_for_multiple_accounts(self) -> BuyContractForMultipleAccounts:
        ...
        """
        return BuyContractForMultipleAccounts(self)
    ...
    @property
    def contracts_for(self) -> ContractsFor:
        ...
        """
        return ContractsFor(self)

    @property
    def contract_update(self) -> ContractUpdate:
        ...
        """
        return ContractUpdate(self)

    @property
    def contract_update_history(self) -> ContractUpdateHistory:
        ...
        """
        return ContractUpdateHistory(self)

    @property
    def copytrading_list(self) -> CopytradingList:
        ...
        """
        return CopytradingList(self)

    @property
    def copytrading_statistics(self) -> CopytradingStatistics:
        ...
        """
        return CopytradingStatistics(self)

    @property
    def copy_start(self) -> CopyStart:
        ...
        """
        return CopyStart(self)

    @property
    def copy_stop(self) -> CopyStop:
    ...
    def forget_all(self) -> ForgetAll:
        ...
        """
        return ForgetAll(self)

    @property
    def get_account_status(self) -> GetAccountStatus:
        ...
        """
        return GetAccountStatus(self)

    @property
    def get_financial_assessment(self) -> GetFinancialAssessment:
        ...
        """
        return GetFinancialAssessment(self)
    ...
    def get_limits(self) -> GetLimits:
        ...
        """
        return GetLimits(self)

    @property
    def get_self_exclusion(self) -> GetSelfExclusion:
        ...
        """
        return GetSelfExclusion(self)

    @property
    def get_settings(self) -> GetSettings:
    ...
    def landing_company(self) -> LandingCompany:
        ...
        """
        return LandingCompany(self)

    @property
    def landing_company_details(self) -> LandingCompanyDetails:
        ...
        """
        return LandingCompanyDetails(self)

    @property
    def login_history(self) -> LoginHistory:
    ...
    @property
    def mt5_deposit(self) -> Mt5Deposit:
        ...
        """
        return Mt5Deposit(self)

    @property
    def mt5_get_settings(self) -> Mt5GetSettings:
        ...
        """
        return Mt5GetSettings(self)

    @property
    def mt5_login_list(self) -> Mt5LoginList:
        ...
        """
        return Mt5LoginList(self)

    @property
    def mt5_new_account(self) -> Mt5NewAccount:
        ...
        """
        return Mt5NewAccount(self)

    @property
    def mt5_password_change(self) -> Mt5PasswordChange:
        ...
        """
        return Mt5PasswordChange(self)

    @property
    def mt5_password_check(self) -> Mt5PasswordCheck:
        ...
        """
        return Mt5PasswordCheck(self)

    @property
    def mt5_password_reset(self) -> Mt5PasswordReset:
        ...
        """
        return Mt5PasswordReset(self)

    @property
    def mt5_withdrawal(self) -> Mt5Withdrawal:
        ...
        """
        return Mt5Withdrawal(self)

    @property
    def new_account_maltainvest(self) -> NewAccountMaltainvest:
        ...
        """
        return NewAccountMaltainvest(self)

    @property
    def new_account_real(self) -> NewAccountReal:
        ...
        """
        return NewAccountReal(self)

    @property
    def new_account_virtual(self) -> NewAccountVirtual:
    ...
    def oauth_apps(self) -> OauthApps:
        ...
        """
        return OauthApps(self)

    @property
    def p2p_advertiser_adverts(self) -> P2PAdvertiserAdverts:
        ...
        """
        return P2PAdvertiserAdverts(self)

    @property
    def p2p_advertiser_create(self) -> P2PAdvertiserCreate:
        ...
        """
        return P2PAdvertiserCreate(self)

    @property
    def p2p_advertiser_info(self) -> P2PAdvertiserInfo:
    ...
    def p2p_advertiser_update(self) -> P2PAdvertiserUpdate:
        ...
        """
        return P2PAdvertiserUpdate(self)

    @property
    def p2p_advert_create(self) -> P2PAdvertCreate:
        ...
        """
        return P2PAdvertCreate(self)

    @property
    def p2p_advert_info(self) -> P2PAdvertInfo:
        ...
        """
        return P2PAdvertInfo(self)

    @property
    def p2p_advert_list(self) -> P2PAdvertList:
        ...
        """
        return P2PAdvertList(self)

    @property
    def p2p_advert_update(self) -> P2PAdvertUpdate:
        ...
        """
        return P2PAdvertUpdate(self)

    @property
    def p2p_chat_create(self) -> P2PChatCreate:
        ...
        """
        return P2PChatCreate(self)

    @property
    def p2p_order_cancel(self) -> P2POrderCancel:
        ...
        """
        return P2POrderCancel(self)

    @property
    def p2p_order_confirm(self) -> P2POrderConfirm:
        ...
        """
        return P2POrderConfirm(self)

    @property
    def p2p_order_create(self) -> P2POrderCreate:
    ...
    def p2p_order_info(self) -> P2POrderInfo:
        ...
        """
        return P2POrderInfo(self)

    @property
    def p2p_order_list(self) -> P2POrderList:
    ...
    def paymentagent_list(self) -> PaymentagentList:
        ...
        """
        return PaymentagentList(self)

    @property
    def paymentagent_transfer(self) -> PaymentagentTransfer:
        ...
        """
        return PaymentagentTransfer(self)

    @property
    def paymentagent_withdraw(self) -> PaymentagentWithdraw:
    ...
    @property
    def profit_table(self) -> ProfitTable:
    ...
    def proposal_open_contract(self) -> ProposalOpenContract:
        ...
        """
        return ProposalOpenContract(self)

    @property
    def reality_check(self) -> RealityCheck:
        ...
        """
        return RealityCheck(self)

    @property
    def residence_list(self) -> ResidenceList:
        ...
        """
        return ResidenceList(self)

    @property
    def revoke_oauth_app(self) -> RevokeOauthApp:
    ...
    @property
    def sell_contract_for_multiple_accounts(self) -> SellContractForMultipleAccounts:
        ...
        """
        return SellContractForMultipleAccounts(self)

    @property
    def sell_expired(self) -> SellExpired:
        ...
        """
        return SellExpired(self)

    @property
    def set_account_currency(self) -> SetAccountCurrency:
        ...
        """
        return SetAccountCurrency(self)

    @property
    def set_financial_assessment(self) -> SetFinancialAssessment:
        ...
        """
        return SetFinancialAssessment(self)

    @property
    def set_self_exclusion(self) -> SetSelfExclusion:
        ...
        """
        return SetSelfExclusion(self)

    @property
    def set_settings(self) -> SetSettings:
    ...
    @property
    def states_list(self) -> StatesList:
    ...
    @property
    def ticks_history(self) -> TicksHistory:
    ...
    @property
    def tnc_approval(self) -> TncApproval:
        ...
        """
        return TncApproval(self)

    @property
    def topup_virtual(self) -> TopupVirtual:
        ...
        """
        return TopupVirtual(self)

    @property
    def trading_durations(self) -> TradingDurations:
    ...
    @property
    def transfer_between_accounts(self) -> TransferBetweenAccounts:
        ...
        """
        return TransferBetweenAccounts(self)
